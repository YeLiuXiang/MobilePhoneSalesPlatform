...
<c:set var="basePath" scope="request">${pageContext.request.contextPath}</c:set>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${basePath}/css/addAdvertisingBooth.css"/>
	...
	<body>
		...
		<div id="container">
			<form  id="AddAdvertisingBoothForm" enctype="multipart/form-data" class="navbar-form navbar-left" role="search">
			   ...
			   <!--  	<input id="linkID" name ="linkID" type="text" class="form-control"> -->
			  	...
			  	<div class="btnDiv">
			  		<input type="button" onclick="AddAdvertisingBooth()" class="btn btn-default" value="确定">
