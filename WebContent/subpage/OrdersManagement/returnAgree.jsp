...
<link rel="stylesheet" type="text/css" href="${basePath}/css/bootstrap.min.css"/>
		...
		function send() {
			...
			window.location = "${basePath}/ReturnOrderServlet?method=ReturnOrderQueryById&searchType=1&id="+ id;
		}
		</script>
	<body>
		<div id="container">
			...
			<div class="row">
				...
				<div class="btn-group">
				  	...
				  	<button onclick="window.location='${basePath}/ReturnOrderServlet?method=ReturnOrderQuery&searchType=1&currentpage=1&account=${sessionScope.account }'" type="button" class="btn btn-info">已同意</button>
			...
			<footer>
					<ul class="pager">
	    				<li><a href="${basePath}/ReturnOrderServlet?method=ReturnOrderQuery&searchType=1&account=${sessionScope.account }&currentpage=${ requestScope.Object.previousPage}">上一页</a></li>
	    				<li><a href="${basePath}/ReturnOrderServlet?method=ReturnOrderQuery&searchType=1&account=${sessionScope.account }&currentpage=${ requestScope.Object.nextPage}">下一页</a></li>
					</ul>
					<form method = "post" action = "${basePath}/ReturnOrderServlet?method=ReturnOrderQuery&searchType=1&account=${sessionScope.account }"  class="navbar-form navbar-right" role="search" >
