...
<c:set var="basePath" scope="request">${pageContext.request.contextPath}</c:set>
	...
	<link rel="stylesheet" type="text/css" href="${basePath}/css/bootstrap.min.css"/>
		...
		<script src="${basePath}/js/commodityBooth.js" type="text/javascript" charset="utf-8"></script>
		</head>
	...
	<body>
		<div id="container">
			<!--位置提醒-->
			<div class="posiRemind">您当前的位置：<span>平台信息管理/商品展位</span> > <strong>在展商品</strong></div>
		...
		<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<c:choose>
							...
							<td class="text-center"><button onclick="Modify(${anno.comId})"	class="btn btn-danger btn-sm">替换</button></td>
						</tr>
					</c:forEach>
		...
		<!--底部分页begin-->
			<footer>
				<ul class="pager">
	    				<li><a href="${basePath}/BoothServlet?method=CommodityBoothQuery&currentpage=${ requestScope.Object.previousPage}">上一页</a></li>
	    				<li><a href="${basePath}/BoothServlet?method=CommodityBoothQuery&currentpage=${ requestScope.Object.nextPage}">下一页</a></li>
					</ul>
