...
<c:set var="basePath" scope="request">${pageContext.request.contextPath}</c:set>
	...
	function send() {
		window.location = "${basePath}/subpage/Announcement/addAnnou.jsp";
	}</script>
		...
		<div >
			<div class="navbar-inner">
				<ul class="nav nav-tabs">
					<li class="active"><a href="#tab1" data-toggle="tab">现有展位</a></li>
					<li><a href="#tab2"  data-toggle="tab">展位申请</a></li>
		...
		<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<c:choose>
							...
							<td class="text-center"><button onclick="Agree(${anno.advId})"	class="btn btn-danger btn-sm">同意</button></td>
						</tr>
					</c:forEach>
			...
			<footer>
				<ul class="pager">
	    				<li><a href="${basePath}/BoothServlet?method=AdvertingBoothApplyQuery&currentpage=${ requestScope.Object.previousPage}">上一页</a></li>
	    				<li><a href="${basePath}/BoothServlet?method=AdvertingBoothApplyQuery&currentpage=${ requestScope.Object.nextPage}">下一页</a></li>
					</ul>
					<form method = "post" action = "${basePath}/BoothServlet?method=AdvertingBoothQuery"  class="navbar-form navbar-right" role="search" >
